...
if (result.kind === 'completed') {
  ...
  await runSharePrompt({
    ...
    analytics,
    markdownPath: result.run.paths.markdown,
    zipPath: result.run.paths.zip,
    markdownContent: result.run.markdown,
